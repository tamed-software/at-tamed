              ...
              <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <div class="row">
                        <div class="col-md-3">
                          <h6 class="m-0 font-weight-bold text-primary">Selecciona un día para nuestra visita</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="m-0 font-weight-bold">Proyecto {{$proyecto->nombre}}</h5>
                        </div>
                    </div>
                      <div class="row">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <div class="form-line">
                                      <label>Selecciona el hogar inteligente</label>
                                      <select name="hogar" id="hogar" class="form-control">
                                          @foreach($hogares as $hogar)
                                                  <option value="{{$hogar->id}}" selected>{{$hogar->vivienda}}</option>
