                  ...
                  <div class="card-body">
                      <div class="pb-1">
                          <div class="row">
                                ...
                                <h5 style="text-align: center; color: #828186">Verifica la información de tu cita; puedes volver a editarla o aceptarla al hacer clic en el botón "Confirmar".</h5>
                        ...
                        <center><a href="{{ route('agendarcliente') }}/?idevento={{$evento->id}}" class="boton-activar">Continuar</a></center>
