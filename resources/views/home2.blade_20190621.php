                ...
                <div class="panel-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <?php
                            ...
                            $porcentaje_clientes_protocolo = $clientes_con_protocolo * 100;
                            $porcentarje_div_con_protocolo = $porcentaje_clientes_protocolo / $sumaEstados;
                            $resultado_con_protocolo = number_format((float)$porcentarje_div_con_protocolo,1,'.','');
                            ...
                            $porcentaje_contratos = $contratos * 100;
                            $porcentaje_contratos_div = $porcentaje_contratos / $total_proyectos;
                            $porcentaje_contratos_final = number_format((float)$porcentaje_contratos_div,1,'.','');
                        ...
                        <div class="table-responsive">
                            <table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th>Clientes con <br> protcolo</th>
                                    <th>Contratos<br>ingresados</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    ...
                                    <td>{{ $clientes_con_protocolo }} <?php echo '('.$resultado_con_protocolo.'%)'; ?> </td>
                                    <td>{{ $contratos }} <?php echo '('.$porcentaje_contratos_final.'%)'; ?> </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
