...
<head>
  ...
  <style type="text/css">
    .bg-login-image{background:url(https://atv2.tamed.global/inmobiliarias/img/login_grupo_activa.jpg);background-position:center;background-size:cover}
  </style>
              ...
              <div class="col-lg-6" style="padding-bottom: 110px; padding-top: 110px;">
                <div class="p-5">
                  <div class="text-center">
                    <h2 >Portal De Control Instalaciones</h2>
                    <br>
                  </div>
                  <form class="user" method="POST" action="{{ route('grupoactiva/login_cliente_inmobiliaria') }}">
                    {{ csrf_field() }}
