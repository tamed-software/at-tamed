...
<head>
  ...
  <style type="text/css">
    .bg-login-image{background:url(http://54.191.69.59:8001/inmobiliarias/img/login.jpg);background-position:center;background-size:cover}
  </style>
            ...
            <div class="row">
              ...
              <div class="col-lg-6" style="padding-bottom: 110px; padding-top: 110px;">
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('hcg/login_cliente_inmobiliaria') }}">
                    {{ csrf_field() }}
