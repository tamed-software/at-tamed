            ...
            <div class="p-5">
              ...
              <form class="user">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repetir clave">
                  </div>
                </div>
                <div class="form-group">
                  <select class="form-control" style="border-radius: 10rem; font-size: 0.8rem;">
                    <option class="form-control" value="">-- Seleccionar inmobiliaria --</option>
                    @foreach($inmobiliarias as $inmobiliaria)
                    <option class="form-control" value="{{ $inmobiliaria->id }}">{{ $inmobiliaria->nombre }}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <hr>
                <a href="http://18.236.97.163:8001/cliente_inmobiliaria" class="btn btn-google btn-user btn-block">
                  <i class="fas fa-arrow-left fa-fw"></i> Volver al inicio
                </a>
