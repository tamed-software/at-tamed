...
<html>
  ...
  <h3 style="text-align: center;">{{ $reflex }}</h3>
  <hr>
  ...
  <hr>
  <h3 style="text-align: center;">{{ $bloom }}</h3>
  <hr>
  ...
  <hr>
  <h3 style="text-align: center;">{{ $parque_la_huasa }}</h3>
  <hr>
  ...
  <table style="width: 100%;">
    ...
    @foreach($pdf_parque_la_huasa as $data)
    <tr>
      <td><small>{{ $data->nombre_estado }}</small></td>
      <td><small>{{ $data->vivienda }}</small></td>
      <td><small>{{ $data->nombre }}</small></td>
  ...
  <hr>
  <h3 style="text-align: center;">{{ $jazz_life_1 }}</h3>
  <hr>
  ...
  <table style="width: 100%;">
    ...
    @foreach($pdf_jazz_life_1 as $data)
    <tr>
      <td><small>{{ $data->nombre_estado }}</small></td>
      <td><small>{{ $data->vivienda }}</small></td>
      <td><small>{{ $data->nombre }}</small></td>
  ...
  <hr>
  <h3 style="text-align: center;">{{ $jazz_life_2 }}</h3>
  <hr>
  ...
  <table style="width: 100%;">
    ...
    @foreach($pdf_jazz_life_2 as $data)
    <tr>
      <td><small>{{ $data->nombre_estado }}</small></td>
      <td><small>{{ $data->vivienda }}</small></td>
      <td><small>{{ $data->nombre }}</small></td>
  ...
  <hr>
  <h3 style="text-align: center;">{{ $jazz_life_3 }}</h3>
  <hr>
  ...
  <table style="width: 100%;">
    ...
    @foreach($pdf_jazz_life_3 as $data)
    <tr>
      <td><small>{{ $data->nombre_estado }}</small></td>
      <td><small>{{ $data->vivienda }}</small></td>
      <td><small>{{ $data->nombre }}</small></td>
