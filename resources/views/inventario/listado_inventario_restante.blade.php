                                ...
                                <table cellpadding="1" cellspacing="1" class="table table-bordered table-striped table-hover" id="tabla_listado_inventario">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Fecha termino instalación</th>
                                            <th>Cantidad viviendas</th>
                                            <th>Total clientes instalados</th>
                                            <th>Producto</th>
                                            <th>Cantidad de productos</th>
                                            <th>Cantidad por instalar</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($datos_inventario_proyecto as $inventario)
                                            <tr>
                                                <td style="display: none;">{{ $inventario['producto_id'] }}</td>
                                                <td>{{ $inventario['nombre_inmobiliaria'] }}</td>
                                                <td>{{ $inventario['nombre_proyecto'] }}</td>
                                                <td>{{ $inventario['fecha_inicio_instalacion'] }}</td>
                                                <td>{{ $inventario['fecha_termino_instalacion'] }}</td>
                                                <td>{{ $inventario['cantidad_viviendas'] }}</td>
                                                <td>{{ $inventario['total_clientes'] }}</td>
                                                <td>{{ $inventario['nombre_producto'] }}</td>
                                                <td>{{ $inventario['cantidad_producto'] }}</td>
                                                <td>{{ $inventario['resto_productos_por_instalar'] }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
