            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                    <label class="control-label" for="fecha_estados">Seleccione fecha</label>
                                    <div class="input-group date" id="datetimepicker1">
                                        <span class="input-group-addon">
                                            <span class="fa fa-calendar"></span>
                                        </span>
                                        <input type="text" class="form-control" id="fecha_estados" name="fecha_estados">
                                    </div>
                            </div>
                            <div class="col-md-2">
                                <br>
                                <button type="button" class="btn btn-small btn-info btn-block" id="btnComparar" onclick="compararGraficos()">Comparar</button>
                            </div>
                        </div>
                        <br>
                        <div class="table-responsive" id="divTabla12">
                    ...
                    <div class="row">
                        <div id="div6"> <!--class="col-md-6"-->
                            <div class="table-responsive" id="divTabla6" hidden="true">
                                <table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>Sin información</th>
                        ...
                        <div class="col-md-6" id="divComparacion" hidden="true"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function compararGraficos(){
        ...
        var fecha = $.trim($('#fecha_estados').val());

        if(fecha == ""){

            var divTabla6 = document.getElementById('divTabla6');
            divTabla6.hidden = true;
            var divTabla12 = document.getElementById('divTabla12');
            divTabla12.hidden = false;
            var div6 = document.getElementById('div6');
            div6.className = "";
            var divComparacion = document.getElementById('divComparacion');
            divComparacion.hidden = true;
            $('#divComparacion').empty();
            ...
            var divTabla6 = document.getElementById('divTabla6');
            divTabla6.hidden = false;
            var divTabla12 = document.getElementById('divTabla12');
            divTabla12.hidden = true;
            var div6 = document.getElementById('div6');
            ...
            $.get('/estadosPorFecha/'+fecha, function(data){

                $('#divComparacion').empty();

                var sin_informacion = data.cant_sin_info;
                var no_contactados = data.cant_no_contactados;
                var contactados = data.cant_contactados;
                var agendados = data.cant_agendados;
                var instalados = data.cant_instalados;
                var con_observacion = data.cant_con_observacion;
                var ins_cap = data.cant_ins_cap;
                var fecha = data.fecha;

                var sumaEstados = sin_informacion+no_contactados+agendados+instalados+con_observacion+ins_cap+contactados;
                var sumaEstadosOtros = sin_informacion+no_contactados+agendados+instalados+con_observacion+contactados;

                var porcentaje_totalSinInformacion = sin_informacion * 100;
                var porcentaje_totalSinInformacion_div = porcentaje_totalSinInformacion / sumaEstados;
                var porcentaje_totalSinInformacion_final = porcentaje_totalSinInformacion_div.toFixed(1);

                var porcentaje_totalNoContactados = no_contactados * 100;
                var porcentaje_totalNoContactados_div = porcentaje_totalNoContactados / sumaEstados;
                var porcentaje_totalNoContactados_final = porcentaje_totalNoContactados_div.toFixed(1);

                var porcentaje_totalContactados= contactados * 100;
                var porcentaje_totalContactados_div = porcentaje_totalContactados / sumaEstados;
                var porcentaje_totalContactados_final = porcentaje_totalContactados_div.toFixed(1);

                var porcentaje_totalAgendados = agendados * 100;
                var porcentaje_totalAgendados_div = porcentaje_totalAgendados / sumaEstados;
                var porcentaje_totalAgendados_final = porcentaje_totalAgendados_div.toFixed(1);

                var porcentaje_totalInstalados = instalados * 100;
                var porcentaje_totalInstalados_div = porcentaje_totalInstalados / sumaEstados;
                var porcentaje_totalInstalados_final = porcentaje_totalInstalados_div.toFixed(1);

                var porcentaje_totalPendientes = con_observacion * 100;
                var porcentaje_totalPendientes_div = porcentaje_totalPendientes / sumaEstados;
                var porcentaje_totalPendientes_final = porcentaje_totalPendientes_div.toFixed(1);

                var porcentaje_totalInstaladosCapacitados = ins_cap * 100;
                var porcentaje_totalInstaladosCapacitados_div = porcentaje_totalInstaladosCapacitados / sumaEstados;
                var porcentaje_totalInstaladosCapacitados_final = porcentaje_totalInstaladosCapacitados_div.toFixed(1);

                var porcentaje_otros_estados = sumaEstadosOtros * 100;
                var porcentarje_div_otros = porcentaje_otros_estados / sumaEstados;
                var result_otros_estados = porcentarje_div_otros.toFixed(1);

                var porcentarje = ins_cap * 100;
                var porcentarje_div = porcentarje / sumaEstados;
                var resultado_estados = porcentarje_div.toFixed(1);

                $('#divComparacion').append('<div class="table-responsive">'+
                                                '<table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">'+
                                                    '<thead>'+
                                                    '<tr>'+
                                                        '<th>Sin información</th>'+
                                                    ...
                                                    '<tbody>'+
                                                    '<tr>'+
                                                        '<td>'+sin_informacion+' ('+porcentaje_totalSinInformacion_final+'%)</td>'+
                                                        '<td>'+no_contactados+' ('+porcentaje_totalNoContactados_final+'%)</td>'+
                                                        '<td>'+contactados+' ('+porcentaje_totalContactados_final+'%)</td>'+
                                                        '<td>'+agendados+' ('+porcentaje_totalAgendados_final+'%)</td>'+
                                                        '<td>'+instalados+' ('+porcentaje_totalInstalados_final+'%)</td>'+
                                                        '<td>'+con_observacion+' ('+porcentaje_totalPendientes_final+'%)</td>'+
                                                        '<td>'+ins_cap+' ('+porcentaje_totalInstaladosCapacitados_final+'%)</td>'+
                                                    '</tr>'+
                                                    '</tbody>'+
                                                '</table>'+
                                            '</div>'+
                                            '<div class="col-md-12 col-sm-12 col-xs-12" id="grafico_comparacion" style="width: 100%; height: 800px; min-height: 550px;">'+
                                            '</div>'+
                                            '<div class="col-md-8 col-md-offset-2">'+
                                                '<table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">'+
                                                    '<thead>'+
                                                    ...
                                                    '<tbody>'+
                                                        '<tr>'+
                                                            '<td>'+ins_cap+' ('+resultado_estados+'%)</td>'+
                                                            '<td>'+sumaEstadosOtros+' ('+result_otros_estados+'%)</td>'+
                                                        '</tr>'+
                                                    '</tbody>'+
                                                '</table>'+
                                            '</div>' );
                ...
                function drawChart70() {
                    ...
                    var data = google.visualization.arrayToDataTable([
                      ['Task', 'Estado de clientes inmobiliarios '+ fecha],
                      ['Sin información', sin_informacion],
                      ['No contactados', no_contactados ],
                      ['Contactados', contactados ],
                      ['Agendados',agendados],
                      ['Instalados', instalados ],
                      ['Con observación',  con_observacion ],
                      ['Instalados y capacitados',  ins_cap ]
                    ]);

                    var options = {
                      title: 'Estado de clientes inmobiliarios '+ fecha,
                      is3D: true,
                      pieSliceText: 'value-and-percentage',
                      //colors: ['#d3ecbd', '#da223d', '#f0ad4e', '#f3fa5b', '#0275d8', '#78712D', '#6f42c1', '#6ac826'],
                    ...
                    var chart = new google.visualization.PieChart(document.getElementById('grafico_comparacion'));
